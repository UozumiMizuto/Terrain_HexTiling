...
#endif
{
    ...
    #ifdef TERRAIN_STANDARD_SHADER
        float4 _SplatExp0;
        hex2colTex(_SplatExp0, weights, _Splat0, uvSplat0, _RotStrength, _Contrast);
        mixedDiffuse += splat_control.r * _SplatExp0 * half4(1.0, 1.0, 1.0, defaultAlpha.r);
        
        float4 _SplatExp1;
        hex2colTex(_SplatExp1, weights, _Splat1, uvSplat1, _RotStrength, _Contrast);
        mixedDiffuse += splat_control.g * _SplatExp1 * half4(1.0, 1.0, 1.0, defaultAlpha.g);
    
        float4 _SplatExp2;
        hex2colTex(_SplatExp2, weights, _Splat2, uvSplat2, _RotStrength, _Contrast);
        mixedDiffuse += splat_control.b * _SplatExp2 * half4(1.0, 1.0, 1.0, defaultAlpha.b);
    
        float4 _SplatExp3;
        hex2colTex(_SplatExp3, weights, _Splat3, uvSplat3, _RotStrength, _Contrast);
        mixedDiffuse += splat_control.a * _SplatExp3 * half4(1.0, 1.0, 1.0, defaultAlpha.a); //mixedDiffuse *= 0;
    #else
        float4 _SplatExp0;
        hex2colTex(_SplatExp0, weights, _Splat0, uvSplat0, _RotStrength, _Contrast);
        mixedDiffuse += splat_control.r * _SplatExp0;
    
    float4 _SplatExp1;
    hex2colTex(_SplatExp1, weights, _Splat1, uvSplat1, _RotStrength, _Contrast);
        mixedDiffuse += splat_control.g * _SplatExp1;
    
    float4 _SplatExp2;
    hex2colTex(_SplatExp2, weights, _Splat2, uvSplat2, _RotStrength, _Contrast);
    mixedDiffuse += splat_control.b * _SplatExp2;
    
    float4 _SplatExp3;
    hex2colTex(_SplatExp3, weights, _Splat3, uvSplat3, _RotStrength, _Contrast);
    mixedDiffuse += splat_control.a * _SplatExp3;
    #endif

    
    #ifdef _NORMALMAP
        float3 _NormalExp0;
        bumphex2derivNMap(_NormalExp0, weights, _Normal0, uvSplat0, _RotStrength, _Contrast, _NormalScale0);
        mixedNormal  = _NormalExp0 * splat_control.r;
        float3 _NormalExp1;
        bumphex2derivNMap(_NormalExp1, weights, _Normal1, uvSplat1, _RotStrength, _Contrast, _NormalScale1);
        mixedNormal +=_NormalExp1 * splat_control.g;
        float3 _NormalExp2;
        bumphex2derivNMap(_NormalExp2, weights, _Normal2, uvSplat2, _RotStrength, _Contrast, _NormalScale2);
        mixedNormal += _NormalExp2 * splat_control.b;
        float3 _NormalExp3;
        bumphex2derivNMap(_NormalExp3, weights, _Normal3, uvSplat3, _RotStrength, _Contrast, _NormalScale3);
        mixedNormal += _NormalExp3 * splat_control.a;
